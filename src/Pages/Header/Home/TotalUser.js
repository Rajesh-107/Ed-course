...
const TotalUser = () => {
  ...
  <li>
    <div class="flex flex-start items-center">
      ...
      <h4 class="text-gray-800 font-semibold text-xl -mt-2">135+ videos in 12 modules</h4>
    </div>
    <div class="ml-6 mb-6 pb-6">
      ...
      <p class="text-gray-700 mt-2 mb-4">The entire course is divided into 12 modules and 135+ videos so that you can learn step by step.</p>
  ...
  <li>
    <div class="flex flex-start items-center">
      <div class="bg-blue-600 w-4 h-4 flex items-center justify-center rounded-full -ml-2 mr-3 -mt-2"></div>
      <h4 class="text-gray-800 font-semibold text-xl -mt-2">30 hours of 15GB of recorded content</h4>
    </div>
    <div class="ml-6 mb-6 pb-6">
      ...
      <p class="text-gray-700 mt-2 mb-4">Video size and duration are optimized taking into account time and bandwidth consumption.</p>
      <button type="button" class="inline-block px-4 py-1.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Read more</button>
    </div>
  </li>
  <li>
    <div class="flex flex-start items-center">
      <div class="bg-blue-600 w-4 h-4 flex items-center justify-center rounded-full -ml-2 mr-3 -mt-2"></div>
      <h4 class="text-gray-800 font-semibold text-xl -mt-2">120+ quizzes</h4>
    </div>
    <div class="ml-6 mb-6 pb-6">
      ...
      <p class="text-gray-700 mt-2 mb-4">There will be quizzes with explanations and answers at the end of each video so that you can check your progress as you learn.</p>
      <button type="button" class="inline-block px-4 py-1.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Read more</button>
    </div>
  </li>
</ol>
