...
const Accrodion = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <img
          ...
          alt="Sampleimage"
        />
      <h1 className="text-5xl font-bold">Answers to frequently asked
questions</h1>
      <p className="py-6">We have listed here the answers to some of your common questions. We request you to read this list once before asking questions. Then you don't have to wait for our reply and save your precious time.</p>
    </div>
